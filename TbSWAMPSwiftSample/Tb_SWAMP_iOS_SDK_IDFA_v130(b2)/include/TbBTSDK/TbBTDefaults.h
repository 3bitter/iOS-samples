...
typedef NS_ENUM(NSInteger, TbBTBeaconType) {
    TbBTBeaconTypeServiceStatic = 1,
    TbBTBeaconTypeServiceDynamic = 2,
    TbBTBeaconTypeOwnedStatic = 3,
    TbBTBeaconTypeOwnedDynamic = 4
};
...
// For dynamic beacons
@property (nonatomic, copy, readonly) NSArray *usingDynamicRegionInfos;
